...
- Choose month: There are checkboxes to each month from May to September with which you can choose the month you are interested. by defaul, data from all the five months are selected.
